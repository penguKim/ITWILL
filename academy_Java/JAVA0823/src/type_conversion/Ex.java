...
public class Ex {
	...
	public static void main(String[] args) {
		/*
		 * 자바에서의 데이터타입간의 형변화(타입 변환)
		 * - 어떤 데이터타입이 다른 데이터타입으로변환하는 것
		 * - 기본 데이터타입 중에 boolean 타입을 제외한 나머지 타입간의 변환
		 * 
		 * 자바 데이터타입 크기 관계
		 ...
		 *   메모리 크기가 long이 float 타입보다 크더라고 float 타입이 큼
		 * 2. 강제 형변환(= 명시적 형변환)
...
//		short c2 = c1; // 오류 발생! 강제 형변환 필수!
		...
		d2 = d1; // 자동형변환(= 묵시적 형변환)
		// int < double
		// => double 타입이 int 타입보다 크므로 컴파일러에 이해 자동으로 변환됨
...
//		l = f; // 오류발셍! float -> long 변환 시 자동형변환이 불가!
		// => long < float 때문에!
