...
class Parent { // class Parent extends Object 와 동일
	...
	public Object parentPrn2() { // 부모 클래스의 리턴 타입 가능
...
//	}
	...
	// --------------------------------------------------------------------
	// 오버라이딩 시 슈퍼클래스의 리턴타입 대신 서브클래스 타입을 명시할 수 있다!
	public String parentPrn2() { // Object 클래스의 자식 클래스인 String 리턴
