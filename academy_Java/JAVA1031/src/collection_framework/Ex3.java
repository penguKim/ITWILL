...
//		System.out.println("4번 인덱스에 저장된 요소 : " + list.get(4));
		...
		//    정수형 요소를 지정해야하는경우 Object 타입으로 변환 필요
//		System.out.println("정수 2 삭제 : " + list.remove(2));
//		System.out.println("list 객체에 저장된 모든 요소 : " + list);
		// => 2번 인덱스로 지정되서 정수 2가 아닌 인덱스의 정수 3이 삭제됨
//		System.out.println("정수 2 삭제 : " + list.remove((Object)2));
		// => 인덱스 번호가 아닌 Object 객체의 데이터라고 명시 가능
//		System.out.println("list 객체에 저장된 모든 요소 : " + list);
		
		// 보통, 요소를 삭제해야할 경우 indexOf() 로 탐색된 인덱스 요소 탐색
		...
		// => 실행할 때마다 셔플 결과는 달라짐
		list2.add("888"); // 다른 데이터타입도 셔플 가능하다.
