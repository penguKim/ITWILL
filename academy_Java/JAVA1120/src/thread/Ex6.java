...
public class Ex6 {
	...
	public static void main(String[] args) {
		...
		// 싱크로나이즈 기능 사용 전
//		모바일 뱅킹 - 출금된 금액 : 3000, 출금 후 잔액 : 7000
//		인터넷 뱅킹 - 출금된 금액 : 3000, 출금 후 잔액 : 7000
//		모바일 뱅킹 - 출금된 금액 : 3000, 출금 후 잔액 : 4000
//		인터넷 뱅킹 - 출금된 금액 : 3000, 출금 후 잔액 : 1000
//		모바일 뱅킹 - 잔액 부족으로 출금 불가!
		
		// 싱크로나이즈 기능 사용 후
//		모바일 뱅킹 - 출금된 금액 : 3000, 출금 후 잔액 : 7000
//		인터넷 뱅킹 - 출금된 금액 : 3000, 출금 후 잔액 : 4000
//		모바일 뱅킹 - 출금된 금액 : 3000, 출금 후 잔액 : 1000
//		인터넷 뱅킹 - 잔액 부족으로 출금 불가!
...
//	public int deposit(int amount) {
	...
	public synchronized int withdraw(int amount) {
		...
		System.out.println(threadName + " - 출금된 금액 : " + amount 
									+ ", 출금 후 잔액 : " + balance);
		return amount;
	}
}
