...
public class Ex4 {
	...
	public static void main(String[] args) {
		...
		int a = 10; // 우변의 데이터 10을 좌변의 변수 a 에 대입(저장)
		int b;
...
//		b = b + a; // 10 + 10 = 20 이 변수 b 에 저장됨(b 에 a 값을 누적)
		...
		// b 와 a 의 뺌셈 결과를 다시 변수 b 에 저장
//		b = b - a; // 20 - 10 = 10 이 변수 b에 저장됨
		b -= a; // b = b -
		System.out.println(b);
		
		// b 와 a 의 곱셈 결과를 다시 변수 b 에 저장
//		b = b * a; // 10 * 10 = 100 이 다시 변수 b 에 저장됨
		b *= a; // b = b * a;
		System.out.println(b);
		
		// b 와 a의 나눗셈 결과를 다시 변수 b 에 저장
//		b = b / a; // 100 / 10 = 10 이 다시 변수 b 에 저장됨
		b /= a; // b = b / a;
		System.out.println(b);
