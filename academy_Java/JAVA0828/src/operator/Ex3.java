...
public class Ex3 {
	...
	public static void main(String[] args) {
		...
		System.out.println(10 + 20); // 30(일반 산술연신 = 덧셈)
		...
		// 주민번호 표현 시
//		int jumin = 930111-1111111; // 결과값 잘못됨 = 뺄셈으로 취급됨
//		int jumin = 9301111111111; // 오류 발생! int 타입으로 표현 불가능함
		
//		long jumin = 930111-1111111l; // long 타입으로 표현하거나
		String jumin = "930111-1111111"; // 문자열로 표현
