...
public class Ex5 {
	...
	public static void main(String[] args) {
		...
		boolean result = (a > b);
//		int result = a > b; // 결과값이 true 또는 false 이므로 int형 변수에는 저장불가!
		...
		System.out.println(0.1); // 0.1XXXXXXXXXXXXXXXX
		System.out.println(0.1f); // 0.1XXXXXXXX
		
		System.out.println(0.1 == 0.1f); // false, 같은 값이나 데이터타입이 다르기에 다른 값으로 취급됨
