...
public class Ex4 {
	...
	public static void main(String[] args) {
		...
		System.out.println(Integer.max(n1, n2)); // Wrapper 클래스 타입 모두 사용 가능
		...
		System.out.println("정수 10을 2진수로 변환 : " + Integer.toOctalString(num1));
		System.out.println("정수 10을 2진수로 변환 : " + Integer.toHexString(num1));
