...
//		int[] score; // int형 정수 여러개를 저장할 배열 score 를 선언
		// => 아직 데이터를 저장할 수 있는 메모리 공간은 생성되지 전
...
//		System.out.println(score[4]); // score 배열의 4번 인덱스 데이터 값 출력
		// => 이 때, 배열은 자동으로 기본값으로 초기화 되므로 0이 출력됨
...
//		System.out.println(score[5]); // 오류 발생!
		...
		// => at array.Ex.main(Ex.java:89) : Ex.java 클래스의 89번 라인이 오류
...
//		System.out.println(score[4]); // score 배열의 4번 인덱스 데이터 값 출력
		...
		for(int i = 0; i < 5; i++) {
			// => 0 ~ 4까지 1씩 증가하는 제어변수 i 를 인덱스 번호로 활용 가능
