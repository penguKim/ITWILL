...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * => FileOutputStream, FileWriter, BufferdOutputStream, BufferedWriter
		 * 
		 ...
		 * => InputStreamReader, OutStreamWriter, BufferedInputStream, BufferedOutStream
		 * 
		 ...
		 *   => System.err : 모니터에 에러 정보를 출력(잘 사용하지 않음)
		 */
		 ...
		 *   => 읽어온 데이터가 int형 이므로 문자로 변환 등 후속 작업 필요
		 * - 가장 저수준의 입력 방법
		 */
...
//			// => IOException 이 발생할 수 있으니 예외 처리 필수!
