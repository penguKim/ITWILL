 ...
 * => 타입파라미터(ex E 또는 T 등) 는 extends 뒤의 클래스 타입이거나 하위 타입만 지정 가능
 */

// class GenericClass3<E> {} // 타입 파라미터 E는 어떤 타입으로도 변경 가능하다.
